...
function symple_shortcodes_add_tinymce_plugin( $plugin_array ) {
	$plugin_array['symple_shortcodes_mce_button'] = get_template_directory_uri() . '/framework/shortcodes/mce/js/symple_shortcodes_tinymce.js';
	return $plugin_array;
}
...
function symple_shortcodes_mce_css() {
	wp_enqueue_style('symple_shortcodes-tc', get_template_directory_uri() . '/framework/shortcodes/mce/css/symple_shortcodes_tinymce_style.css');
}
