            ...
            $this->sections[] = array(
                ...
                'fields'    => array(
                    ...
                    array(
                        'id'        => 'display_phone',
                        'type'      => 'button_set',
                        'title'     => __('Contact phone at the top', 'dankov'),
                        'options'   => array(
                            '1' => 'Display', 
                            '2' => "Don't Display"
                        ), 
                    ...
                    array(
                        'id'        => 'Phone_number',
                        'type'      => 'text',
                        'required'  => array('display_phone', '=', '1'),
                        'title'     => __('Phone Number', 'dankov'),
                        'subtitle'  => __('Place here your contact phone number. Example: +0 987 654 321.', 'dankov'),
                        'desc'      => __('Please use numbers only', 'redux-framework-demo'),
                        'default'   => '+0 987 654 321',
                    ),

                    array(
                        'id'        => 'display_date',
                        'type'      => 'button_set',
                        'title'     => __('Display current date?', 'dankov'),
                        'options'   => array(
                            '1' => 'Display', 
                            '2' => "Don't Display"
                        ), 
            ...
            $this->sections[] = array(
                ...
                'fields'    => array(
                    ...
                    array(
                        'id'        => 'post_thumb_set',
                        'type'      => 'button_set',
                        'title'     => __('Show thumbnail.', 'dankov'),
                        'subtitle'  => __('Show thumbnail in post', 'dankov'),
                   ...
                   array(
                        ...
                        'type'      => 'image_select',
                        'title'     => __('Sidebar Position', 'dankov'),
            ...
            $this->sections[] = array(
                ...
                'fields'    => array(
                    ...
                    array(
                        ...
                        'default'   => 'Design by <a href="http://themeforest.net/user/Dankov">Dankov</a>',
                    ),
            ...
            $this->sections[] = array(
                ...
                'fields'    => array(
                    ...
                    array(
                        ...
                        'type'      => 'color',
                        'title'     => __('Define a Custom Color Scheme', 'dankov'),
                        'subtitle'  => __('You can define a new custom color for the Planer scheme.', 'dankov'),
                        'default'   => '',
                        'transparent' => false,
                        'validate'  => 'color',
                    ),
                    ...
                    array(
                        ...
                        'type'      => 'color',
                        'title'     => __('Define a Custom Color Scheme for ', 'dankov'),
                        'subtitle'  => __('You can define a new custom color for the Planer scheme.', 'dankov'),
                        'default'   => '',
                        'transparent' => false,
                        'validate'  => 'color',
            ...
            $this->sections[] = array(
                ...
                'fields'    => array(
                    ...
                    array(
                        'id'        => 'header_social',
                        'type'      => 'switch',
                        'title'     => __('Social Icons in Header', 'dankov'),
                        'subtitle'  => __('Enable/Disable social icons for the header. If enabled, the social icons block will be displayed in the header nav bar.', 'dankov'),
                        'default'   => 1,
                        'on'        => 'Enabled',
                        'off'       => 'Disabled'
                    ),  
            ...
            $this->sections[] = array(
                ...
                'fields'    => array(
                    ...
                    array(
                        ...
                        'default'   => '<img src="http://wordpress.dankov-theme.com/planer/wp-content/themes/planer/assets/images/head-banner.png">',
                    ),
                    ),
            );
...
// IMPORT/EXPORT SETTINGS
        ...
        public function setArguments() {
            ...
            $this->args = array(
                ...
                'opt_name'          => 'dankov',            // This is where your data is stored in the database and also becomes your global variable name.
                'display_name'      => $theme->get('Name'),     // Name that appears at the top of your panel
                'display_version'   => $theme->get('Version'),  // Version that appears at the top of your panel
                'menu_type'         => 'submenu',                  //Specify if the admin menu should appear or not. Options: menu or submenu (Under appearance only)
                'allow_sub_menu'    => true,                    // Show the sections below the admin menu item or not
                'menu_title'        => __('Theme Options', 'dankov'),
                'page_title'        => __('Theme Options', 'dankov'),
