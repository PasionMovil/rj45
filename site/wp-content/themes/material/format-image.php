<?php global $data; ?>
<?php
	global $content_class, $first_big_post_counter, $divide_counter;
	...
	<?php
		...
		<?php } ?> 
			...
			<?php } else { ?>
				...
				<a class="paper-button btn-next image"  href="<?php the_permalink(); ?>"></a>
		...
		<div class="entry-meta">
			...
			<?php if(!is_single()) { ?>
				...
				<ul>  
					...
					<li><i class="icon-arrow-right"></i> <span><a href="<?php the_permalink() ?>"><?php _e('More', 'dankov'); ?></a></span></li>
				</ul>
