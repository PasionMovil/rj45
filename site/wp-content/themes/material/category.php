	...
	<div class="container">
		...
		<?php if ( have_posts() ) : ?>
			<header class="archive-header">
				<h3 class="archive-title archive-category"><?php printf( __( '%s', 'dankov' ), '<span>' . single_cat_title( '', false ) . '</span>' ); ?></h3>
			...
			<?php endif; ?>
				...
				<?php }
					...
					echo "<p class='not-found'>".__('Sorry, no posts in this category.', 'dankov')."</p>";
